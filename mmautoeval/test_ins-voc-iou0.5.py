...
from mmdet.core import coco_eval, results2json, results2json_segm, wrap_fp16_model, tensor2imgs, get_classes, coco_eval2
        ...
        if eval_types:
            ...
            if eval_types == ['proposal_fast']:
                ...
                if not isinstance(outputs[0], dict):
                    ...
                    coco_eval2(result_files, eval_types, dataset.coco)
                else:
