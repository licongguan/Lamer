...
def get_config():
    ...
    for city in os.listdir(foggy_img_path):
        ...
        with open(target_config_path + config_name, 'r') as f:
            lines = f.readlines()
            lines[66] = "data_root = '../MyTrain/ModelEval/Public-cityspace_test_FD_AP/0{}_AL/map/coco/'".format(i) + '\n'
...
if __name__ == '__main__':
    foggy_img_path = '../DATA/Public data set/CitySpace/MyCitySpace/ImgFoggy/foggy_beta_0.02/'
    cityspace_json_all = '../DATA/Public data set/CitySpace/MyCitySpace/labelme8类注/annotations_train2017/'
    save_map_FD_path = '../MyTrain/ModelEval/Public-cityspace_test_FD_AP/'
    if not osp.exists(save_map_FD_path):
        os.makedirs(save_map_FD_path)
    default_config_path = '../MyTrain/ModelEval/Public-cityspace/02_AL/solov2_Public_cityspace_02_AL.py'
    save_config_path = '../MyTrain/ModelEval/Public-cityspace/'
